<x-tahfidz-layout>
            ...
            <div class="overflow-x-auto">
                <table id="guruTable" class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400 italic">Belum ada data guru.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <script>
        ...
        const guruFilterForm = document.querySelector('form[action="{{ route('admin.guru.index') }}"]');
        if (guruFilterForm) {
            guruFilterForm.addEventListener('submit', (e) => {
                e.preventDefault();
