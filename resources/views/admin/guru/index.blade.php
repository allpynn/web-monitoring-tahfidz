<x-tahfidz-layout>
    ...
    <div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <select onchange="window.location.href='{{ route('admin.guru.index') }}?sort=' + this.value" class="py-2 pl-3 pr-8 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm focus:ring-emerald-500 focus:border-emerald-500 cursor-pointer">
