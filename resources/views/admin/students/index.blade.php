            ...
            <form action="{{ route('admin.students.index') }}" method="GET" class="flex flex-col lg:flex-row gap-4 items-end">
                ...
                <div class="flex gap-2 w-full lg:w-auto">
                    ...
                    @if(request()->anyFilled(['search', 'gender', 'sort', 'per_page']))
                        <a href="{{ route('admin.students.index') }}" class="px-4 py-2.5 bg-gray-100 dark:bg-gray-700 text-gray-500 rounded-2xl flex items-center justify-center hover:bg-gray-200 transition-all font-bold">
                            Reset
                        </a>
                    @endif
                </div>
