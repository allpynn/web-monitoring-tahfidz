        ...
        <div class="flex flex-wrap items-center gap-3">
            <div class="relative">
                <input type="text" id="searchSantri" placeholder="Cari santri..."
                    class="pl-10 pr-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm focus:ring-emerald-500 focus:border-emerald-500 w-64"
            ...
            <select
                onchange="window.location.href='{{ route('admin.students.index') }}?sort={{ request('sort') }}&gender=' + this.value"
                class="py-2 pl-3 pr-8 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm focus:ring-emerald-500 focus:border-emerald-500 cursor-pointer">
            ...
            <select
                onchange="window.location.href='{{ route('admin.students.index') }}?gender={{ request('gender') }}&sort=' + this.value"
                class="py-2 pl-3 pr-8 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm focus:ring-emerald-500 focus:border-emerald-500 cursor-pointer">
                ...
                <thead>
                    <tr class="bg-gray-50/50 dark:bg-gray-900/50 border-b border-gray-100 dark:border-gray-700">
                        ...
                        <th
                            ...
                            Target(JUZ)</th>
                        <th
                            class="px-6 py-4 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-emerald-600">
                            Terverifikasi Selesai</th>
                        <th
                            class="px-6 py-4 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                            Aksi</th>
                    </tr>
                        ...
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-900/30 transition-colors group">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-10 h-10 rounded-xl bg-emerald-100 dark:bg-emerald-900/40 flex items-center justify-center text-emerald-700 dark:text-emerald-400 font-bold">
                                        {{ substr($student->name, 0, 1) }}
                                    </div>
                                    <div>
                                        <div class="text-sm font-bold text-gray-900 dark:text-white">{{ $student->name }}
                                        </div>
                            ...
                            <td class="px-6 py-4">
                                @if($student->gender === 'Laki-laki')
                                    <span
                                        class="inline-flex items-center justify-center px-2 py-1 text-xs font-bold rounded bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-400"
                                        title="Laki-laki">L</span>
                                @elseif($student->gender === 'Perempuan')
                                    <span
                                        class="inline-flex items-center justify-center px-2 py-1 text-xs font-bold rounded bg-pink-100 text-pink-700 dark:bg-pink-900/40 dark:text-pink-400"
                            ...
                            <td class="px-6 py-4">
                                <span
                                    class="px-3 py-1 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 text-xs font-bold rounded-full">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-wrap gap-1">
                                    @php $completedCount = count($student->completed_juz); @endphp
                                    ...
                                    @empty
                                        @if($student->memorizations->count() > 0)
                                            <span class="text-[10px] text-gray-400 italic">Sedang Berproses...</span>
                                        @else
                                            <span class="text-[10px] text-gray-400 italic">Belum Ada Setoran</span>
                                        @endif
                                    @endforelse
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <a href="{{ route('admin.students.export', $student) }}"
