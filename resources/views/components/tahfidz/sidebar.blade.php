            ...
            <li>
                <a href="{{ route('guru.messages') }}"
                   ...
                   @if(isset($unreadMessagesCount))
                      <span id="sidebar-unread-badge" class="{{ $unreadMessagesCount > 0 ? '' : 'hidden' }} inline-flex items-center justify-center w-5 h-5 ms-3 text-xs font-black text-white bg-red-500 rounded-full">
                         {{ $unreadMessagesCount }}
                      </span>
                   @endif
                </a>
