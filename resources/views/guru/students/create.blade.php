<x-tahfidz-layout>
    ...
    <x-slot name="subtitle">
        Daftarkan santri baru yang berada di bawah bimbingan Anda. Akun orang tua akan otomatis dibuat atau dihubungkan.
    </x-slot>

    <div class="max-w-3xl">
        <div class="mb-6">
            <a href="{{ route('guru.students.index') }}" class="text-sm font-bold text-emerald-700 dark:text-emerald-500 flex items-center gap-2 hover:gap-3 transition-all">
    ...
    <style>
        ...
        #parent-search-results::-webkit-scrollbar { width: 4px; }
        #parent-search-results::-webkit-scrollbar-track { background: transparent; }
        #parent-search-results::-webkit-scrollbar-thumb { background: #d1fae5; border-radius: 4px; }
    </style>
    @endpush
</x-tahfidz-layout>