            ...
            <form action="{{ route('guru.students.index') }}" method="GET" class="flex flex-col lg:flex-row gap-4">
                ...
                <div class="w-full lg:w-48">
                    ...
                    <select name="gender" onchange="this.form.submit()" 
                            class="w-full bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-2xl text-sm focus:ring-emerald-500 focus:border-emerald-500 shadow-sm cursor-pointer font-bold font-bold">
                ...
                <div class="flex gap-2 w-full lg:w-auto">
                    ...
                    @if(request()->anyFilled(['search', 'gender', 'sort']))
