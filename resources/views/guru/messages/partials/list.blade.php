<div class="space-y-3 mt-4" id="message-list-content">
    @forelse($parent_messages as $msg)
        <div class="border border-gray-100 dark:border-gray-700/50 rounded-3xl overflow-hidden transition-all duration-300"
            :class="openChat === {{ $msg->id }} ? 'bg-emerald-50/50 dark:bg-emerald-900/10 ring-1 ring-emerald-100 dark:ring-emerald-800/30' : 'hover:bg-gray-100/50 dark:hover:bg-gray-800/60 bg-gray-50 dark:bg-gray-800/50'">
            ...
            <div class="p-4 cursor-pointer flex items-center justify-between"
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-[11px] font-bold text-gray-400 dark:text-gray-500 flex items-center gap-1.5 mt-0.5 uppercase tracking-wider">
            ...
            <div x-show="openChat === {{ $msg->id }}" x-collapse x-cloak>
                <div class="p-4 bg-white/50 dark:bg-gray-900/40 border-t border-gray-100 dark:border-gray-800">
                    <div class="space-y-4 mb-6 max-h-[500px] overflow-y-auto px-2 custom-scrollbar">
    ...
    @empty
        <div class="flex flex-col items-center justify-center py-20 bg-gray-50/30 dark:bg-gray-900/10 rounded-[40px] border-2 border-dashed border-gray-100 dark:border-gray-800">
