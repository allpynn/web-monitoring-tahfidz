<x-tahfidz-layout>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-3xl overflow-hidden shadow-sm mb-8">
                ...
                <div class="flex-1 w-full">
                    ...
                    <div class="relative">
                        <input type="text" name="search" value="{{ request('search') }}" 
                               ...
                               oninput="filterHafalan(this.value)">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                <tbody id="hafalanTableBody" class="divide-y divide-gray-100 dark:divide-gray-700 text-sm">
                        ...
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-900/30 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('guru.hafalan.edit', $item) }}" class="p-2 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-xl transition-all"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg></a>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-10 text-center text-gray-500 italic">Riwayat tidak ditemukan.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    @push('scripts')
        <script>
            function filterHafalan(val) {
                const query = val.toLowerCase();
                const rows = document.querySelectorAll('#hafalanTableBody tr');
                rows.forEach(row => {
