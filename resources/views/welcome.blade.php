...
<head>
    ...
    <!-- Fonts: Outfit for professionalism -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@100..900&family=Amiri:ital,wght@0,400;0,700;1,400;1,700&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        .dark .simple-glow-bg {
            background-color: #030712; /* Deeper background */
        ...
        .orb-green { background: rgba(16, 185, 129, 0.1); width: 600px; height: 600px; top: -100px; right: -100px; }
        .dark .orb-green { background: rgba(5, 150, 105, 0.12); }
        ...
        .dark .pro-card {
            background: #0f172a; /* Slightly lighter than bg for contrast */
        ...
        .hover-bounce:hover { animation: subtle-bounce 2s ease-in-out infinite; }
    </style>
</head>
<body class="antialiased simple-glow-bg transition-colors duration-500 selection:bg-emerald-100 selection:text-emerald-900 min-h-screen overflow-x-hidden">
    ...
    <div class="fixed inset-0 flex items-center justify-center pointer-events-none z-0 overflow-hidden">
        <div class="relative w-full max-w-2xl px-4 scale-75 lg:scale-100">
            <!-- Green Light Aura -->
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] lg:w-[600px] h-[400px] lg:h-[600px] bg-emerald-600/25 dark:bg-emerald-500/15 rounded-full blur-[100px] lg:blur-[140px] pointer-events-none"></div>
    ...
    <div class="fixed top-4 lg:top-8 right-4 lg:right-8 z-50">
        <button id="theme-toggle" type="button" 
            ...
            <svg id="theme-toggle-dark-icon" class="hidden w-5 h-5 text-slate-600 group-hover:text-emerald-600" fill="currentColor" viewBox="0 0 20 20"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
            <svg id="theme-toggle-light-icon" class="hidden w-5 h-5 text-emerald-500 group-hover:text-emerald-400" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464l-.707-.707a1 1 0 00-1.414 1.414l.707.707a1 1 0 001.414-1.414zm2.12 10.607a1 1 0 010-1.414l.706-.707a1 1 0 111.414 1.414l-.707.707a1 1 0 01-1.414 0z" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
        </button>
    </div>
    ...
    <main class="min-h-screen w-full flex flex-col lg:flex-row relative z-10">
        ...
        <!-- SIDE 1: BRANDING -->
        <div class="w-full lg:w-[50%] flex flex-col justify-center items-center lg:items-end p-10 lg:p-24 lg:pr-12 text-center lg:text-right">
            <div class="max-w-xl w-full">
                <div class="space-y-4 lg:space-y-2 mb-10 lg:mb-12 animate-in slide-in-from-left duration-700">
                    <span class="block text-[11px] lg:text-[13px] font-black tracking-[0.4em] uppercase text-emerald-600 dark:text-emerald-500 opacity-80">Sistem Monitoring Terpadu</span>
                    <h1 class="text-5xl lg:text-7xl font-black text-slate-900 dark:text-white leading-[1.05] tracking-tight">
                        Tahfidz <br> <span class="text-emerald-600 dark:text-emerald-500 underline decoration-4 lg:decoration-8 underline-offset-8">Al-Mujahidin</span>
                    </h1>
                </div>

                <div class="space-y-8 lg:space-y-8 animate-in slide-in-from-left duration-1000 delay-150">
                    <p class="arabic text-5xl lg:text-6xl text-slate-800 dark:text-emerald-400 font-bold leading-relaxed">
                        خَيْرُكُمْ مَنْ تَعَلَّمَ الْقُرْآنَ وَعَلَّمَهُ
                    </p>
                    <p class="text-lg lg:text-xl text-slate-500 dark:text-slate-400 font-medium italic max-w-sm lg:ml-auto">
                        "Sebaik-baik kalian adalah orang yang belajar Al-Qur'an dan mengajarkannya."
                        <span class="block mt-3 text-xs lg:text-sm font-bold text-slate-400 not-italic uppercase tracking-widest">— HR. Bukhari</span>
                    </p>
                </div>

                <!-- Feature Pills -->
                <div class="mt-12 lg:mt-16 flex flex-wrap justify-center lg:justify-end gap-3 lg:gap-4 animate-in fade-in duration-1000 delay-300">
                    <div class="px-6 py-3 bg-slate-100/80 dark:bg-slate-800/80 backdrop-blur-sm text-slate-600 dark:text-slate-400 rounded-2xl font-bold text-xs lg:text-sm border border-slate-200/50 dark:border-slate-700/50">Premium Monitoring</div>
                    <div class="px-6 py-3 bg-emerald-50/80 dark:bg-emerald-900/30 backdrop-blur-sm text-emerald-700 dark:text-emerald-400 rounded-2xl font-bold text-xs lg:text-sm border border-emerald-100/50 dark:border-emerald-800/50">Secure Access</div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-[50%] flex items-center justify-center lg:justify-start">
            ...
            <div class="w-full h-full min-h-[600px] lg:min-h-screen">
                ...
                <div class="pro-card h-full w-full p-10 lg:p-24 flex flex-col justify-center rounded-t-[3rem] lg:rounded-t-0 lg:rounded-l-[4rem] animate-in slide-in-from-right duration-700">
                    <div class="max-w-md w-full mx-auto lg:mx-0">
                        <div class="mb-12">
                            <h2 class="text-4xl font-black text-slate-900 dark:text-white tracking-tight mb-4">Selamat Datang</h2>
                            <p class="text-slate-500 dark:text-slate-400 text-base font-medium leading-relaxed">
                                Silakan masuk menggunakan email atau username dan kata sandi Anda untuk memantau perkembangan hafalan santri secara langsung.
                            </p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-6">
                            ...
                            <!-- Identifier -->
                            <div class="space-y-2">
                                <label for="email" class="block text-xs lg:text-sm font-bold text-slate-500 dark:text-slate-400 ml-1 tracking-wide">Email / Nomor HP</label>
                                <div class="relative group">
                                    ...
                                    <input id="email" type="text" name="email" value="{{ old('email', Cookie::get('remember_email')) }}" required autofocus placeholder="Masukkan Email atau Nomor HP"
                            ...
                            <!-- Password -->
                            <div class="space-y-2">
                                <label for="password" class="block text-xs lg:text-sm font-bold text-slate-500 dark:text-slate-400 ml-1 tracking-wide">Kata Sandi</label>
                                <div class="relative group">
                                    <div class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none text-slate-400 group-focus-within:text-emerald-500 transition-colors">
                                    ...
                                    <button type="button" id="toggle-password" class="absolute inset-y-0 right-0 pr-5 flex items-center text-slate-400 hover:text-emerald-600 transition-colors cursor-pointer focus:outline-none">
                                        ...
                                        <svg id="eye-off-icon" class="hidden h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mt-16 text-center opacity-40">
                            <p class="text-[10px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-[0.5em]">
