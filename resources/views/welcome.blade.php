...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Sistem Monitoring Tahfidz</title>
        ...
        <nav class="fixed w-full z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800">
            ...
            <div id="mobile-menu" class="hidden md:hidden bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 animate-fade-in-down">
                <div class="px-4 pt-2 pb-6 space-y-2">
                    <a href="#fitur" class="block px-4 py-3 text-base font-bold text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-xl transition-all">Fitur</a>
                    <a href="#tentang" class="block px-4 py-3 text-base font-bold text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-xl transition-all">Tentang</a>
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="p-8 bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700 flex items-center text-emerald-700 dark:text-emerald-400 font-semibold text-sm group-hover:gap-2 transition-all">
                    ...
                    <div class="p-8 bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700 flex items-center text-emerald-700 dark:text-emerald-400 font-semibold text-sm">
                            <span>Lihat detail</span>
                            <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                        </div>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul class="space-y-4">
                            <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-emerald-700 dark:hover:text-emerald-500 transition-colors">Beranda</a></li>
                            <li><a href="#fitur" class="text-gray-600 dark:text-gray-400 hover:text-emerald-700 dark:hover:text-emerald-500 transition-colors">Fitur Utama</a></li>
                            <li><a href="#tentang" class="text-gray-600 dark:text-gray-400 hover:text-emerald-700 dark:hover:text-emerald-500 transition-colors">Tentang Kami</a></li>
